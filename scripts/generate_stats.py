...
Env:
  ...
  GH_LOGIN      user to summarise (default: Ankitesh999)
...
def main():
    ...
    login = os.environ.get("GH_LOGIN", "Ankitesh999")
    ...
    for word in ("about", "tech stack", "research & publications", "github activity & stats"):
